...
typedef void (^CoreDataInitCallbackBlock)(void);

@interface KTZCoreDataController : NSObject
 ...
 */
- (id _Nonnull)initWithCallback:(CoreDataInitCallbackBlock _Nullable)callback;
